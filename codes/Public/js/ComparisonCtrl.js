...
mainApp.controller('ComparisonCtrl', function ($scope, $http,$window) {
    ...
    function readDataV2(){
        ...
        if(bGu){
            ...
            arrExchange=[false,true,true];  // whether exchange
        }
        else{
            arrFiles=[
            ...
            arrExchange=[false,false];  // whether exchange
        }
        ...
        function preprocessData(){
            ...
            arrSeries.forEach(function(d,i){
                if(arrExchange[i]){
                    arrSeries[i].forEach(function(dd,j){
                        var temp=arrSeries[i][j].foot1;
                        arrSeries[i][j].foot1=arrSeries[i][j].foot2;
                        arrSeries[i][j].foot2=temp;

                        temp=arrSeries[i][j].hand1;
                        arrSeries[i][j].hand1=arrSeries[i][j].hand2;
                        arrSeries[i][j].hand2=temp;

                        temp=arrSeries[i][j].pos1;
                        arrSeries[i][j].pos1=arrSeries[i][j].pos2;
                        arrSeries[i][j].pos2=temp;


                        temp=arrSeries[i][j].parry_pos1;
                        arrSeries[i][j].parry_pos1=arrSeries[i][j].parry_pos2;
                        arrSeries[i][j].parry_pos2=temp;

                        if(arrSeries[i][j].score==1) arrSeries[i][j].score=2;
                        else if(arrSeries[i][j].score==2) arrSeries[i][j].score=1;
                    })
                }
            })
            ...
            arrPhrases.forEach(function(d,i){
                if(i>0) bias+=arrPhrases[i-1].length;
            ...
            if(arrFiles.length==3)
                ...
                $scope.fencingData.flow_groups=[arrFlows[0][0],arrFlows[1][0]];
